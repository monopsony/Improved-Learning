...
def run(dataset_path,n_train=950,n_val=50,n_epochs=1000):
    ...
    if os.path.exists(os.path.join(storage_dir,"split.npz")):
        os.remove(os.path.join(storage_dir,"split.npz"))
    ...
    train,val,test=spk.train_test_split(
    	...
    	num_train=n_train,
    	num_val=n_val,
    	split_file=os.path.join(storage_dir,"split.npz"),
    	)
